...
class TaskListViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let incompletedTasks = incompletedTasks(of: taskList)
    ...
    private func incompletedTasks(of list: TaskList) -> String {
        var status = "0"
        if list.tasks.count != 0 {
            let incompleteCount = list.tasks.filter("isComplete = false").count
